import{j as e}from"./jsx-runtime-CkxqCPlQ.js";import{r as i}from"./index-DJO9vBfz.js";import{d as j}from"./styled-components.browser.esm-Dsr6U-en.js";import{g as V}from"./style-x6FuVGrZ.js";import{d as Z}from"./theme-DTREIjCk.js";import{B as W}from"./Button-CpD3pMnL.js";function ee(...n){return t=>{n.forEach(c=>{typeof c=="function"?c(t):c!=null&&(c.current=t)})}}const ne=j.div`
...
`,G=i.createContext({activeValues:[],multiple:!1}),Y=i.createContext({toggleItem:()=>{}}),J=()=>{const n=i.useContext(G);if(!n)throw new Error("useAccordion must be used within AccordionProvider");return n},ie=()=>{const n=i.useContext(Y);if(!n)throw new Error("useAccordionDispatch must be used within AccordionProvider");return n},se=(n,t)=>{const{children:c,multiple:r=!1,defaultValue:a,value:d,onChange:u,style:s,className:l,...m}=n,[b,y]=i.useState(r?a??[]:a!==void 0?[a]:[]),H=d!==void 0,I=H?r?d:[d]:b,Q=f=>{let A;I.includes(f)?A=r?I.filter(X=>X!==f):[]:A=r?[...I,f]:[f],H||y(A),u&&u(r?A:A[0]??"")};return e.jsx(G.Provider,{value:{activeValues:I,multiple:r},children:e.jsx(Y.Provider,{value:{toggleItem:Q},children:e.jsx(ne,{className:l,style:s,ref:t,...m,children:c})})})},K=i.createContext(null),L=()=>{const n=i.useContext(K);if(!n)throw new Error("useAccordionItem must be used within AccordionItem");return n},ae=i.forwardRef(({children:n,value:t,className:c,style:r,...a},d)=>e.jsx(K.Provider,{value:{value:t},children:e.jsx(oe,{className:c,style:r,...a,ref:d,children:n})})),de=e.jsx("polyline",{points:"6 9 12 15 18 9",stroke:Z.colors.gray[600],strokeWidth:"2",fill:"none"}),le=i.forwardRef(({children:n,className:t,style:c,...r},a)=>{const{activeValues:d,toggleItem:u,value:s}=(()=>{const{value:m}=L(),{activeValues:b}=J(),{toggleItem:y}=ie();return{activeValues:b,toggleItem:y,value:m}})(),l=d.includes(s);return e.jsxs(te,{$expanded:l,onClick:()=>u(s),"aria-expanded":l,"aria-controls":`accordion-content-${s}`,id:`accordion-header-${s}`,role:"button",className:t,style:c,ref:a,...r,children:[n,e.jsx(ce,{viewBox:"0 0 24 24",$expanded:l,children:de})]})}),ue=i.forwardRef(({children:n,className:t,style:c,...r},a)=>{const{activeValues:d}=J(),{value:u}=L(),s=d.includes(u),l=i.useRef(null),m=i.useRef(0);return i.useEffect(()=>{l.current&&(s?m.current=l.current.scrollHeight:m.current=0)},[s]),e.jsx(re,{$expanded:s,$height:m.current,role:"region",id:`accordion-content-${u}`,"aria-labelledby":`accordion-header-${u}`,className:t,style:c,ref:ee(l,a),...r,children:n})}),o=i.forwardRef(se);o.Item=ae;o.Header=le;o.Content=ue;o.__docgenInfo={description:"",methods:[],displayName:"Accordion",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""},className:{required:!1,tsType:{name:"string"},description:""},multiple:{required:!1,tsType:{name:"boolean"},description:""},defaultValue:{required:!1,tsType:{name:"T"},description:""},value:{required:!1,tsType:{name:"T"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: T) => void",signature:{arguments:[{type:{name:"T"},name:"value"}],return:{name:"void"}}},description:""}},composes:["Omit"]};const me={title:"Components/Accordion",component:o,parameters:{docs:{description:{component:`
**Accordion 컴포넌트**
...
\`\`\`
          `}}}},x={name:"커스텀 스타일 적용",render:n=>e.jsx(o,{...n,children:e.jsxs(o.Item,{value:"item1",children:[e.jsx(o.Header,{style:{backgroundColor:"lightblue",color:"white"},children:"헤더 1"}),e.jsx(o.Content,{style:{backgroundColor:"lightblue",color:"white"},children:"콘텐츠 1"})]})}),parameters:{docs:{description:{story:`
**커스텀 스타일 적용**
...
\`\`\`
          `}}}};var w,S,$;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: "기본 아코디언",
...
}`,...($=(S=p.parameters)==null?void 0:S.docs)==null?void 0:$.source}}};var B,k,R;h.parameters={...h.parameters,docs:{...(B=h.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: "단일 확장 (언컨트롤드)",
  render: args => <Accordion {...args}>
      <Accordion.Item value="item1">
        <Accordion.Header>
...
}`,...(R=(k=h.parameters)==null?void 0:k.docs)==null?void 0:R.source}}};var P,T,N;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: "다중 확장 (언컨트롤드)",
  args: {
    multiple: true
  },
...
}`,...(N=(T=g.parameters)==null?void 0:T.docs)==null?void 0:N.source}}};var O,E,_;v.parameters={...v.parameters,docs:{...(O=v.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: "단일 확장 (컨트롤드)",
  render: args => {
    const [activeValue, setActiveValue] = useState<string | null>(null);
    return <>
...
}`,...(_=(E=v.parameters)==null?void 0:E.docs)==null?void 0:_.source}}};var D,U,q;C.parameters={...C.parameters,docs:{...(D=C.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: "다중 확장 (컨트롤드)",
  args: {
    multiple: true
  },
...
}`,...(q=(U=C.parameters)==null?void 0:U.docs)==null?void 0:q.source}}};var z,M,F;x.parameters={...x.parameters,docs:{...(z=x.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: "커스텀 스타일 적용",
  render: args => <Accordion {...args}>
      <Accordion.Item value="item1">
...
}`,...(F=(M=x.parameters)==null?void 0:M.docs)==null?void 0:F.source}}};const Ae=["Default","UncontrolledSingle","UncontrolledMultiple","ControlledSingle","ControlledMultiple","CustomStyling"],je=Object.freeze(Object.defineProperty({__proto__:null,ControlledMultiple:C,ControlledSingle:v,CustomStyling:x,Default:p,UncontrolledMultiple:g,UncontrolledSingle:h,__namedExportsOrder:Ae,default:me},Symbol.toStringTag,{value:"Module"}));export{o as A,C,p as D,h as U,g as a,x as b,je as c};
